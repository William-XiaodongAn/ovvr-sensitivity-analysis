...
% identifiability index of the ten Tusscher model with cisapride
clear all;

% Set up model
Tstop = 500; % Simulation time (in ms)
[model, m] = tentusscher_model();
model.init_parameters = @tentusscher_init_parameters_cisapride;
model.init_states = @tentusscher_init_states_cisapride;
