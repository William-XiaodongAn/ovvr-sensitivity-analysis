function [parameters, varargout] = tentusscher_init_parameters()
  % % Default parameter values for ODE model: tentusscher_2006_epi
  % % ------------------------------------------------------------
  % %
  % % parameters = tentusscher_init_parameters();
  % % [parameters, parameters_names] = tentusscher_init_parameter();
