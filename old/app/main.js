 ...
 *------------------------------------------------------------------------
 */
    env.cur1 = new Abubu.Float32Texture(env.width, env.height) ;
    env.cur2 = new Abubu.Float32Texture(env.width, env.height) ;
    env.cur3 = new Abubu.Float32Texture(env.width, env.height) ;
    env.cur4 = new Abubu.Float32Texture(env.width, env.height) ;
 ...
 */
    ...
    env.cica.pairable = true ;
    env.cick.pairable = true ;
    env.cikn.pairable = true ;
    env.cinc.pairable = true ;
        ...
        if (env.running){
            for(var i=0 ; i< env.frameRate/10 ; i++){
                ...
                if ( env.time >= initial_wait-100 ){
                    x_scaled = Math.floor(record_position_x*env.width) ;
                    y_scaled = Math.floor(record_position_y*env.height) ;
                    current_recorder += ';' + env.fvvxc.value[(x_scaled*env.width + y_scaled)*4];
                    current_recorder += ';' + env.cica.value[(x_scaled*env.width + y_scaled)*4] +','+
                                        env.cica.value[(x_scaled*env.width + y_scaled)*4+1]+','+
                                        env.cica.value[(x_scaled*env.width + y_scaled)*4+2]+','+
                                        env.cica.value[(x_scaled*env.width + y_scaled)*4+3];
                    current_recorder += ';' + env.cick.value[(x_scaled*env.width + y_scaled)*4] +','+
                                        env.cick.value[(x_scaled*env.width + y_scaled)*4+1]+','+
                                        env.cick.value[(x_scaled*env.width + y_scaled)*4+2]+','+
                                        env.cick.value[(x_scaled*env.width + y_scaled)*4+3];
                    current_recorder += ';' + env.cikn.value[(x_scaled*env.width + y_scaled)*4] +','+
                                        env.cikn.value[(x_scaled*env.width + y_scaled)*4+1]+','+
                                        env.cikn.value[(x_scaled*env.width + y_scaled)*4+2]+','+
                                        env.cikn.value[(x_scaled*env.width + y_scaled)*4+3];
                    current_recorder += ';' + env.cinc.value[(x_scaled*env.width + y_scaled)*4] +','+
                                        env.cinc.value[(x_scaled*env.width + y_scaled)*4+1]+','+
                                        env.cinc.value[(x_scaled*env.width + y_scaled)*4+2]+','+
                                        env.cinc.value[(x_scaled*env.width + y_scaled)*4+3];
                    current_recorder += '\n';
                }
